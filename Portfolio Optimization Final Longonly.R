...
getSymbols("^GSPC",from="2012-10-01",to="2014-11-26",src="yahoo",colnames=0)
SP500.Clo=GSPC[,6]
...
# Writing a csv file along with the dates
Stock_GSPC=as.data.frame(GSPC)
write.csv(Stock_GSPC,file="GSPC.csv")
...
MVP.weights=efficientPortfolio(Returns.Portfolio.Stocks,spec=portfolio.spec)
MVP.weights
...
# Calculating Weights of Tangency Portfolio & Risk Free Asset given return=21.15276%/Year

mean.portfolio=0.2115276
riskFreeRate
